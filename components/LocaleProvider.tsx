...
const messages: Record<Locale, Record<string, string>> = {
  ...
  en: {
    ...
    "channel.explore": "Explore Studios",
    "channel.exploreDesc": "Discover studios from various creators.",
    "channel.noChannels": "No studios found.",
    "channel.official": "Official Studio",
